...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/pain-odk.yaml)
...
```
  <uri name="http://purl.obolibrary.org/obo/pain/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/pain-edit.obo)
for .obo formats: 

```
import: http://purl.obolibrary.org/obo/pain/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/pain.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
