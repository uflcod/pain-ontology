 ...
 * [pain.yml](pain.yml)
     * Determines how your purl.obolibrary.org/obo/pain/ redirects will be handled
     ...
     * Paste in the contents of [pain.yml](pain.yml)
 ...
 * [pain.md](pain.md)
     ...
     * Paste in the contents of [pain.md](pain.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
